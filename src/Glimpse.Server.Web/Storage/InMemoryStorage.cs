...
namespace Glimpse.Server
{
    ...
    public struct RequestIndices
    {
        ...
        public RequestIndices(IMessageEnvelope message)
        {
            ...
            _duration = indices["request.duration"] as float?;
            _statusCode = indices["request.statuscode"] as int?;
            _url = indices["request.url"] as string;
            _method = indices["request.method"] as string;
            _statusCode = indices["request.statuscode"] as int?;
        }
